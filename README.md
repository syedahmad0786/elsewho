...
- Parallel-universe dating profile
...
```
/?n=Ada%20Lovelace&h=ada
```

Open Graph card: `/api/og?n=Ada`
...
[a Fun Toy](https://fun-toys-alpha.vercel.app) · [prev](https://the-elsewhere.vercel.app) · [next](https://jigmoji.vercel.app)
